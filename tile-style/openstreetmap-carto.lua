...
local function prefer_tamil_name(tags)
...
function filter_tags_node (keyvalues, numberofkeys)
    local filter, tags = filter_tags_generic(keyvalues)
    return filter, prefer_tamil_name(tags)
end
...
function filter_basic_tags_rel (keyvalues, numberofkeys)
    ...
    return 0, prefer_tamil_name(keyvalues)
end
...
function filter_tags_way (keyvalues, numberofkeys)
    ...
    return filter, prefer_tamil_name(keyvalues), polygon, roads(keyvalues)
end
